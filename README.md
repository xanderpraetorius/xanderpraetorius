...
|-|-|-|
|[**AI Customer Data Mining Framework**](https://github.com/your-username/customer-data-mining)|NLP and ML pipeline using DeBERTa, RoBERTa, and BERTopic on the Amazon Reviews '23 dataset. Produces customer segmentation and sentiment forecasts to drive business model innovation.|`PyTorch` `Hugging Face` `CRISP-DM` `Python`|
|[**Multi-Modal VAE — Perspective Alignment**](https://github.com/your-username/mvae-perspective)|Shared latent space bridging first-person (joint-position) and third-person (RGB) views. Cross-modal alignment linked to mirror neuron theory.|`PyTorch` `Deep Generative Models` `Python`|
